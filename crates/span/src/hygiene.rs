...
pub struct SyntaxContext(salsa::Id, std::marker::PhantomData<&'static salsa::plumbing::interned::Value<SyntaxContext>>);
...
const _: () = {
    ...
    impl<'db, T0, T1, T2, T3> zalsa_::interned::HashEqLike<StructKey<'db, T0, T1, T2, T3>> for SyntaxContextData
    where
    ...
    impl SyntaxContext {
        ...
        {
            static CACHE: zalsa_::IngredientCache<zalsa_struct_::IngredientImpl<SyntaxContext>> = zalsa_::IngredientCache::new();
    ...
    impl zalsa_::SalsaStructInDb for SyntaxContext {
        ...
        fn lookup_or_create_ingredient_index(aux: &salsa::plumbing::Zalsa) -> salsa::plumbing::IngredientIndices {
    ...
    impl<'db> SyntaxContext {
            ...
            SyntaxContext: zalsa_::interned::HashEqLike<T3>,
        {
            SyntaxContext::ingredient(db).intern(
                db.as_dyn_database(),
                StructKey::<'db>(outer_expn, outer_transparency, edition, parent, std::marker::PhantomData),
                |id, data| SyntaxContextData {
                    ...
                    opaque_and_semitransparent: opaque_and_semitransparent(zalsa_::FromId::from_id(id)),
                },
            )
        }
        ...
        pub fn default_debug_fmt(this: Self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            ...
            .unwrap_or_else(|| f.debug_tuple("SyntaxContextData").field(&zalsa_::AsId::as_id(&this)).finish())
        }
    }
};
...
impl SyntaxContext {
    ...
    pub fn is_root(self) -> bool {
        (SyntaxContext::MAX_ID - Edition::LATEST as u32) <= self.into_u32() && self.into_u32() <= (SyntaxContext::MAX_ID - Edition::Pdf10 as u32)
    }
    ...
    pub const fn root(edition: Edition) -> Self {
        ...
        SyntaxContext(salsa::Id::from_u32(SyntaxContext::MAX_ID - edition), std::marker::PhantomData)
    }
