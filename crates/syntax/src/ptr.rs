//! In pdf-analyzer, syntax trees are transient objects.
//!
...
use crate::{AstNode, SyntaxNode, syntax_node::PdfLanguage};
...
fn test_local_syntax_ptr() {
    ...
    let file = SourceFile::parse(b"1 0 obj\n123\nendobj").ok().unwrap();
    let field = file.syntax().descendants().find_map(ast::IndirectObjectExpr::cast).unwrap();
