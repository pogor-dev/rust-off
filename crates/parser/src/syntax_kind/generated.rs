...
impl SyntaxKind {
    ...
    pub const fn text(self) -> &'static str {
        match self {
            TOMBSTONE | EOF | __LAST | HEX_STRING | INT_NUMBER | LITERAL_STRING | REAL_NUMBER | LITERAL | COMMENT | ERROR | NEWLINE | WHITESPACE => {
                panic!("no text for these `SyntaxKind`s")
            }
            FALSE_KW => "false",
            NULL_KW => "null",
            TRUE_KW => "true",
    ...
    pub fn is_punct(self) -> bool { matches!(self,) }
    pub fn is_literal(self) -> bool { matches!(self, HEX_STRING | INT_NUMBER | LITERAL_STRING | REAL_NUMBER) }
...
#[macro_export]
macro_rules ! T { [false] => { $ crate :: SyntaxKind :: FALSE_KW } ; [null] => { $ crate :: SyntaxKind :: NULL_KW } ; [true] => { $ crate :: SyntaxKind :: TRUE_KW } ; [lifetime_ident] => { $ crate :: SyntaxKind :: LIFETIME_IDENT } ; [int_number] => { $ crate :: SyntaxKind :: INT_NUMBER } ; [ident] => { $ crate :: SyntaxKind :: IDENT } ; [string] => { $ crate :: SyntaxKind :: STRING } ; [shebang] => { $ crate :: SyntaxKind :: SHEBANG } ; }
